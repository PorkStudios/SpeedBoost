...
public class OptimizeExplosionsTranslator implements IConfigTranslator {
    public static final OptimizeExplosionsTranslator INSTANCE = new OptimizeExplosionsTranslator();
    public boolean state;

    private OptimizeExplosionsTranslator() {
